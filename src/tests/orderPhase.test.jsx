...
test('order phases for happy path', async() => {
    ...
    const loadingTag = screen.getByText(/loading/i);
    expect(loadingTag).toBeInTheDocument();

    // confirm we have order number on confirmation page
    // this one is async because there is a POST request to server in between order
